...
if($.fn.wl_Form) $.fn.wl_Form.defaults = {
	...
	text: {
		...
		valid: 'Este Campo es Invalido',
		password: 'El Password es Muy Corta',
		passwordmatch: 'Los Passwords no Coinciden',
		fileinqueue: 'Hay un Archivo en Cola',
		incomplete: 'Por Favor, Ingrese Los datos del formulario Nuevamente!',
		send: 'Enviando Formulario...',
		sendagain: 'Volver a Enviar el Formulario?',
